...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "initSaveData", function(name:String, ?folder:String = 'preload') {
	...
	function initLuaShader(name:String, ?glslVersion:Int = 120)
	{
		...
		var foldersToCheck:Array<String> = [Paths.getPreloadPath('lua/shaders/')];
...
class ModchartText extends FlxText
{
	...
	public function new(x:Float, y:Float, text:String, width:Float)
	{
		...
		setFormat(Paths.font("Brose.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class DebugLuaText extends FlxText
{
	...
	public function new(text:String, parentGroup:FlxTypedGroup<DebugLuaText>, color:FlxColor) {
		...
		setFormat(Paths.font("Brose.ttf"), 20, color, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scrollFactor.set();
		borderSize = 1;
	}
